  ...
  <div className="footer-up-med mx-0 mx-sm-5 mx-lg-0">
    <div className="footer-up-elem mx-0 mx-sm-5 mx-md-0">
      ...
      <p className="text-center">
        Descubre la belleza de la segunda oportunidad en nuestra tienda de ropa
        de segunda mano.Súmate a la moda consciente. Cada prenda cuenta una
        historia, ¡hazla parte de la tuya!.
      </p>
    </div>
  </div>
